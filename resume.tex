...
\resumeSubHeadingListStart
    ...
    \resumeProject
      {Friends App - Backend} %Project Name
      {An application for finding friends near your area in both a fun and private way.} %Project Name, Location Name
      {02/2023 - Present} %Event Dates

      \resumeItemListStart
      \item {Created a scalable Node.js backend with an interest and distance based Matching Algorithm.}
    \resumeItemListEnd
    \vspace{-2mm}
